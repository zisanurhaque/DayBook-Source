            ...
            <main>
                ...
                <div className="desc">
                    ...
                    <div className="dataInsert">
                        <input onChange={(e) => setDate(e.target.value)} className="inputDate" type="date"/>
                        <input onChange={(e) => setTitle(e.target.value)} className="title" type="text" placeholder="Title"/>
                        <input onChange={(e) => setMoney(parseInt(e.target.value))} className="value" type="number" placeholder="value($)"/>
                        <button onClick={debitHandler} className="dbt">Debit</button>
                        <button onClickCapture={creditHandler}>Credit</button>
                    </div>
                </div>
